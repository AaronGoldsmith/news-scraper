  ...
  $.getJSON("/articles", function (data)
  {
    for (var i = 0; i < data.length - 1; i++) {
      $("#results").prepend(
        ...
        " <div id='wrapper' class=' rounded mx-1 p-1 text-center border bg-secondary rounded-3'>" +
        ...
        "<div class='bg-white rounded mb-1 w-80'><img class='my-3 logo mx-auto' src='https://www.thoughtco.com/thmb/g6QxWI4GWet9HeUT4NEqTIJ7B_g=/3325x664/filters:fill(auto,1)/The-Onion-581247455f9b58564cb87f03.jpg' width=250 height=50 /></div>" +
        "<div class='data-entry card text-left p-2' data-id=" + data[i]._id + ">" +
